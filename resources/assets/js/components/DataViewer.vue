    ...
    <div class="dv">
        <div class="dv-header">
            ...
            <div class="dv-header-search">
                <input type="text" class="dv-header-input" v-model="query.search_input" @keyup.enter="fetchIndexData()" placeholder="Search">
            </div>
        ...
        <div class="dv-body">
            <table class="dv-table">
                <thead>
                    <tr>
                        <th v-for="column in columns" :key="column" @click="toggleOrder(column)">
                            <span>{{ column }}</span>
                ...
                <tbody>
                    <tr v-for="row in model.data" :key="row.id">
                        <td v-for="(value, key) in row" :key="value + key">{{ value }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="dv-footer">
            ...
            <div class="dv-footer-item">
                ...
                <div class="dv-footer-sub">
                    ...
                    <input type="text" v-model="query.page" class="dv-footer-input" @keyup.enter="fetchIndexData()">
    ...
    export default {
        ...
        methods: {
            ...
            fetchIndexData() {
                ...
                axios.get(`${this.source}?column=${this.query.column}&direction=${this.query.direction}&search_column=${this.query.search_column}&search_operator=${this.query.search_operator}&search_input=${this.query.search_input}&per_page=${this.query.per_page}&page=${this.query.page}`)
                    .then((response) => {
